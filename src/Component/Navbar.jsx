            ...
            <div className="bg-blue-500">
                <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
                    ...
                    <ul className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 hidden md:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
                        ...
                        <li className='flex'><NavLink to="about" className={({ isActive }) => isActive ? "text-sm text-white bg-orange-500 px-4 py-2 rounded" : "text-sm text-black px-4 py-2 font-medium"}>About Us</NavLink></li>

                        <li className='flex'><NavLink to="services" className={({ isActive }) => isActive ? "text-sm text-white bg-orange-500 px-4 py-2 rounded" : "text-sm text-black px-4 py-2 font-medium"}>Services</NavLink></li>

                        <li className='flex'><NavLink to="collection" className={({ isActive }) => isActive ? "text-sm text-white bg-orange-500 px-4 py-2 rounded" : "text-sm text-black px-4 py-2 font-medium"}>Collection</NavLink></li>

                        <li className='flex'><NavLink to="contact" className={({ isActive }) => isActive ? "text-sm text-white bg-orange-500 px-4 py-2 rounded" : "text-sm text-black px-4 py-2 font-medium"}>Contact</NavLink></li>

                        <li className='flex'>
                            <NavLink to="cart" className={({ isActive }) => isActive ? "text-sm text-white bg-orange-500 px-4 py-2 rounded" : "text-sm text-black px-4 py-2 font-medium border border-gray-300 rounded-lg"}>
